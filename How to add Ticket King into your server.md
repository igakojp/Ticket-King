<pre style="white-space: pre-wrap;">Let's say that you already own a Discord server.
...
Scrool down, until you get to the bottom.
There should be `add to server` in the bottom, and a select button under it.
<img src="./image/Select_a_server.png">
